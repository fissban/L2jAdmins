 ...
 * @author fissban
 */
public class NpcVoteRewardNetwork extends AbstractMod
{
	private static final int NPC = 60015;
	// player q esta votando
	private static PlayerHolder player = null;
	private static int votes = 0;
	
	public NpcVoteRewardNetwork()
	{
		registerMod(ConfigData.ENABLE_VoteRewardIndivualNetwork);
	}
	...
	public void onTimer(String timerName, NpcHolder npc, PlayerHolder ph)
	{
		...
		{
			case "waitVote":
				if (VoteReward.getVotesNetwork() > votes)
				{
