 ...
 * @author Reynald0
 */
public class Q047_IntoTheDarkForest extends Script
{
	// NPCS
	...
	// REWARD
	private static final int SCROLL_OF_ESCAPE_DARK_ELVEN_VILLAGE = 7556;
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		{
			st.rewardItems(SCROLL_OF_ESCAPE_DARK_ELVEN_VILLAGE, 1);
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		{
			case CREATED:
				htmltext = (player.getLevel() >= 3) && st.hasItems(MARK_OF_TRAVELER) && (player.getRace() == Race.DARK_ELF) ? "7097-02.htm" : "7097-01.htm";
				break;
