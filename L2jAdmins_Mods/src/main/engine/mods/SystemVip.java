...
public class SystemVip extends AbstractMod
{
	...
	private void informeExpireVip(PlayerHolder ph)
	{
		...
		hb.append("<td fixwidth=164 align=center><font color=LEVEL>", ConfigData.VIP_BONUS_XP * 100 - 100, "%</font></td>");
		hb.append("</tr>");
		hb.append("</table>");
		hb.append("<img src=L2UI.SquareGray width=264 height=1>");
		hb.append("<table fixwidth=264>");
		...
		hb.append("<td fixwidth=164 align=center><font color=LEVEL>", ConfigData.VIP_BONUS_SP * 100 - 100, "%</font></td>");
		hb.append("</tr>");
		hb.append("</table>");
		hb.append("<img src=L2UI.SquareGray width=264 height=1>");
		...
		hb.append("<td fixwidth=82 align=center><font color=LEVEL>", ConfigData.VIP_BONUS_DROP_NORMAL_AMOUNT * 100 - 100, "%</font></td>");
		hb.append("<td fixwidth=82 align=center><font color=LEVEL>", ConfigData.VIP_BONUS_DROP_NORMAL_AMOUNT * 100 - 100, "%</font></td>");
		hb.append("</tr>");
		hb.append("</table>");
		hb.append("<img src=L2UI.SquareGray width=264 height=1>");
		...
		hb.append("<td fixwidth=82 align=center><font color=LEVEL>", ConfigData.VIP_BONUS_DROP_SPOIL_AMOUNT * 100 - 100, "%</font></td>");
		hb.append("<td fixwidth=82 align=center><font color=LEVEL>", ConfigData.VIP_BONUS_DROP_SPOIL_CHANCE * 100 - 100, "%</font></td>");
		hb.append("</tr>");
		hb.append("</table>");
		hb.append("<img src=L2UI.SquareGray width=264 height=1>");
		hb.append("<table fixwidth=264 border=0 cellspacing=0 cellpadding=0>");
		...
		hb.append("<td fixwidth=82 align=center><font color=LEVEL>", ConfigData.VIP_BONUS_DROP_SEED_AMOUNT * 100 - 100, "%</font></td>");
		hb.append("<td fixwidth=82 align=center><font color=LEVEL>", ConfigData.VIP_BONUS_DROP_SEED_AMOUNT * 100 - 100, "%</font></td>");
		hb.append("</tr>");
		hb.append("</table>");
		hb.append("<img src=L2UI.SquareGray width=264 height=1>");
