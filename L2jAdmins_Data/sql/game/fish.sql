...
CREATE TABLE `fish` (
  ...
  `fish_type` tinyint(1) NOT NULL DEFAULT 0, -- 0 = wide, 1 = swift, 2 = ugly, 3 = box, 4 = easy_wide, 5 = easy_swift, 6 = easy_ugly
  `fish_group` tinyint(1) NOT NULL DEFAULT 0, -- 0 = easy, 1 = normal
